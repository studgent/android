...
public class QuizQuestionsDataSource implements IDataSource {
	...
	private void populateList(){
		...
		items.put(0, new QuizQuestion(1, 10, "Bouwjaar van de boekentoren?", false, null, "1942", new GregorianCalendar(2013,1,28,13,24,56), new LatLng(51.044935, 3.725798)));
		ArrayList<String> solutions = new ArrayList<String>();
		solutions.add("Apen");solutions.add("Bananen");solutions.add("Olifant");solutions.add("Schoolboeken");			
		items.put(1, new QuizQuestion(1, 2, "Wat hoort niet in de rij?", false, solutions, "Schoolboeken", new GregorianCalendar(2013,1,28,13,24,56), new LatLng(51.0436016,3.7210573)));
